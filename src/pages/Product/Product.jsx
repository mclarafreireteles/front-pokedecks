                        ...
                        <Stack spacing={3} >
                            ...
                            <Paper variant="outlined" sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper' }}>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={6}>
                                        <Typography variant="caption" color="text.secondary" display="block">COLEÇÃO (ID)</Typography>
                                    ...
                                    {product.metadata && (
                                        <>
                                            ...
                                            <Grid item xs={6}>
                                                <Typography variant="caption" color="text.secondary" display="block">HP</Typography>
                                                <Typography variant="body1" fontWeight={500}>
                                                    {product.metadata.hp || '-'}
                                                </Typography>
                                            </Grid>
                                            <Grid item xs={6}>
                                                <Typography variant="caption" color="text.secondary" display="block">ESTÁGIO</Typography>
                                                <Typography variant="body1" fontWeight={500}>
                                                    {product.metadata.stage || '-'}
                                                </Typography>
                                            </Grid>
                                            <Grid item xs={6}>
                                                <Typography variant="caption" color="text.secondary" display="block">DEX ID</Typography>
                                                <Typography variant="body1" fontWeight={500}>
