...
import {
    ...
    Table, TableBody, TableCell, TableHead, TableRow, Avatar, Divider, Button, Chip
} from "@mui/material";
            ...
            <Container maxWidth="md" sx={{ py: 5, minHeight: '80vh' }}>
                ...
                {isLoading ? (
                    ...
                    <Box display="flex" flexDirection="column" alignItems="center" py={8}>
                        ...
                        <Typography variant="h6" color="text.secondary" mt={2}>Você ainda não fez nenhum pedido.</Typography>
                    ...
                    <Box sx={{ mt: 3 }}>
                        {orders.map((order) => (
                            <Accordion key={order.id} sx={{ mb: 2, borderRadius: '8px !important', boxShadow: 2, '&:before': { display: 'none' } }}>
                                <AccordionSummary expandIcon={<FiChevronDown />}>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center', flexWrap: 'wrap', gap: 2, pr: 2 }}>
                                        <Box>
                                            <Typography variant="subtitle1" fontWeight="bold">
                                                Pedido <span style={{ fontFamily: 'monospace', color: '#666' }}>#{order.id}</span>
                                            </Typography>
