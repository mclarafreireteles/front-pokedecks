      ...
      <div className="lp-content-column">
        <Link to="/" className="join-us-link">
          <h1 className="lp-logo">
            poke<span>decks</span>
          </h1>
        </Link>
        <div className="text-content">
          <h2 className="text-content-title">Catch 'Em All: Explore Our Pokemon Card Catalog!</h2>
          <p className="text-content-text">
            Discover a world of Pokemon cards, from rare gems to classic favorites. Start your
            collection or find that missing card in our premier Pokemon card shop.
          </p>
          <div className="lp-btn-container">
            <Button typeColor="primary" onClick={() => handleOtherPage('/login')}>
              Sign In
            </Button>
            <Button typeColor="secondary" onClick={() => handleOtherPage('/register')}>
              Register
            </Button>
          </div>
        </div>
